...
model = Sequential()
model.add(Dense(286, input_shape=(len(train_x[0]),), activation='relu'))
...
train_process = model.fit(np.array(train_x), np.array(train_y), epochs=150, batch_size=10, verbose=2)
